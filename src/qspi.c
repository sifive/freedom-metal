...
extern __inline__ void metal_qspi_init(struct metal_qspi *qspi, uint32_t baud_rate);
extern __inline__ int metal_qspi_setconfig(struct metal_qspi *qspi,qspi_static_config_t *cfg);
extern __inline__ void metal_qspi_setcommand_params(struct metal_qspi *qspi,qspi_command_config_t *cparams,qspi_static_config_t *cfg);
...
extern __inline__ void metal_qspi_execute_cmd(struct metal_qspi *qspi);
