...
void soc_init()
{
	...
	rd_dt = METAL_PCSS_REGW(PCSS_SCR_RESET_BASE_ADDR + PCSS_SCR_PCSS_MISC_NIU_RESET);
	rd_dt = (rd_dt | 0x2);
	METAL_PCSS_REGW(PCSS_SCR_RESET_BASE_ADDR + PCSS_SCR_PCSS_MISC_NIU_RESET)=rd_dt;

	
	/*Deassert reset of all UARTs */

	rd_dt = METAL_PCSS_REGW(PCSS_SCR_REG_BASE_ADDR + PCSS_SCR_PCSS_MISC_RESET);
	rd_dt = (rd_dt & ~0xE02);
	METAL_PCSS_REGW(PCSS_SCR_REG_BASE_ADDR + PCSS_SCR_PCSS_MISC_RESET)=rd_dt;

	METAL_PCSS_REGW(PCSS_SCR_RESET_BASE_ADDR + PCSS_SCR_PNOCSS_RESET)=0x63F;
	METAL_PCSS_REGW(PCSS_SCR_RESET_BASE_ADDR + PCSS_SCR_PCSS_MISC_NIU_RESET)=0xB97;//Deassert AON PCNOC NIU Reset
	METAL_PCSS_REGW(PCSS_SCR_RESET_BASE_ADDR + PCSS_SCR_LSPERIPHSS_UART_NIU_RESET)=0X1F;
	METAL_PCSS_REGW(PCSS_SCR_RESET_BASE_ADDR + PCSS_SCR_LSPERIPHSS_MISC_NIU_RESET)=0xFFF;
	METAL_PCSS_REGW(PCSS_SCR_RESET_BASE_ADDR + PCSS_SCR_HSPERIPHSS_NIU_RESET)=0x70;
	METAL_PCSS_REGW(PCSS_SCR_RESET_BASE_ADDR + PCSS_SCR_EMMC_SDIO_NIU_RESET) = 0X49; //Deassert EMMC/SDIO NIU Reset
	METAL_PCSS_REGW(PCSS_SCR_RESET_BASE_ADDR + PCSS_SCR_PMISCSS_QSPI_NIU_RESET) = 0x6;  //Deassert QSPI NIU Reset

	/*******************IP RESET *************************/
	METAL_PCSS_REGW(PCSS_SCR_RESET_BASE_ADDR + PCSS_PINMUX_SCR_RESET)=0x0;
	METAL_PCSS_REGW(PCSS_SCR_REG_BASE_ADDR + PCSS_SCR_LSPERIPHSS_UART_RESET)=0X0;
	METAL_PCSS_REGW(PCSS_SCR_REG_BASE_ADDR + PCSS_SCR_HSPERIPHSS_RESET)=0x0;
	METAL_PCSS_REGW(PCSS_SCR_REG_BASE_ADDR + PCSS_SCR_PMISCSS_QSPI_RESET) = 0X0;      //Deassert QSPI Reset
	METAL_PCSS_REGW(PCSS_SCR_REG_BASE_ADDR + PCSS_SCR_EMMC_SDIO_RESET) = 0;   //Deassert EMMC/SDIO Reset
	for(volatile int i=0;i<2000;i++);

	METAL_PCSS_REGW(PCSS_SCR_CUST_REG_BASE_ADDR+PCSS_SCR_AON_PAD_RET_EN)=0;
	...
	METAL_PCSS_REGW(PCSS_SCR_RESET_BASE_ADDR + PCSS_PINMUX_SCR_RESET)=0x1;
	METAL_PCSS_REGW(PCSS_SCR_REG_BASE_ADDR + PCSS_SCR_LSPERIPHSS_UART_RESET)=0X1F;
	METAL_PCSS_REGW(PCSS_SCR_REG_BASE_ADDR + PCSS_SCR_HSPERIPHSS_RESET)=0x7E;
	METAL_PCSS_REGW(PCSS_SCR_REG_BASE_ADDR + PCSS_SCR_PMISCSS_MISC_RESET)=0xF;//Deassert PMISCSS Reset
	METAL_PCSS_REGW(PCSS_SCR_REG_BASE_ADDR + PCSS_SCR_PMISCSS_QSPI_RESET) = 0X7;      //Deassert QSPI Reset
	METAL_PCSS_REGW(PCSS_SCR_REG_BASE_ADDR + PCSS_SCR_EMMC_SDIO_RESET) = 0X1FF;   //Deassert EMMC/SDIO Reset

	for(volatile int i=0;i<2000;i++);
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_QSPI0_SCK) = 0x1301;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_QSPI0_DQ0) = 0x1301;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_QSPI0_DQ1) = 0x1301;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_QSPI0_DQ2) = 0x1301;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_QSPI0_DQ3) = 0x1301;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_QSPI0_CS)  = 0x1301;

	METAL_PCSS_REGW(PCSS_SCR_IOMUX_PCSS_CFG_BASE_ADDR + PCSS_SCR_IOMUX_CONFIG_UART1_TXD)= 0x00001E01; //pull up txd
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_PCSS_CFG_BASE_ADDR + PCSS_SCR_IOMUX_CONFIG_UART1_RTS)= 0x00001E01; //pull up rts
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_PCSS_CFG_BASE_ADDR + PCSS_SCR_IOMUX_CONFIG_UART1_RXD)= 0x00001F01; //pull up rxd
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_PCSS_CFG_BASE_ADDR + PCSS_SCR_IOMUX_CONFIG_UART1_CTS)= 0x00001F01; //pull up cts

	METAL_PCSS_REGW(PCSS_SCR_IOMUX_PCSS_CFG_BASE_ADDR + PCSS_SCR_IOMUX_CONFIG_UART0_TXD)= 0x00001E01; //pull up txd
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_PCSS_CFG_BASE_ADDR + PCSS_SCR_IOMUX_CONFIG_UART0_RTS)= 0x00001E01; //pull up rts
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_PCSS_CFG_BASE_ADDR + PCSS_SCR_IOMUX_CONFIG_UART0_RXD)= 0x00001F01; //pull up rxd
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_PCSS_CFG_BASE_ADDR + PCSS_SCR_IOMUX_CONFIG_UART0_CTS)= 0x00001F01; //pull up cts


	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_EMMC0_CLK) = 0x5500;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_EMMC0_CMD) = 0x5500;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_EMMC0_DAT0) = 0x5500;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_EMMC0_DAT1) = 0x5500;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_EMMC0_DAT2) = 0x5500;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_EMMC0_DAT3) = 0x5500;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_EMMC0_DAT4) = 0x5500;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_EMMC0_DAT5) = 0x5500;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_EMMC0_DAT6) = 0x5500;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_EMMC0_DAT7) = 0x5500;
	METAL_PCSS_REGW(PCSS_SCR_IOMUX_HSSS_CFG_BASE_ADDR + HSSS_SCR_IOMUX_CONFIG_EMMC0_DS) = 0x5500;
