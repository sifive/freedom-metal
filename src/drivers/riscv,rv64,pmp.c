...
void __mee_driver_riscv_rv64_pmp_init(struct mee_pmp *gpmp)
{
    struct __mee_driver_riscv_rv64_pmp *pmp = (void *)gpmp;
...
int __mee_driver_riscv_rv64_pmp_set_region(struct mee_pmp *gpmp,
                                           unsigned int region,
...
int __mee_driver_riscv_rv64_pmp_get_region(struct mee_pmp *gpmp,
                                           unsigned int region,
                                           struct mee_pmp_config *config,
                                           size_t *address)
{
