...
int
__metal_driver_riscv_plic0_register_handler(struct metal_interrupt controller, int id,
                                               metal_interrupt_handler_t handler,
                                               void *priv_data);

int __metal_driver_riscv_plic0_register_vector_handler(
...
unsigned int
__metal_driver_riscv_plic0_get_priority(struct metal_interrupt controller, int id);
...
metal_affinity
__metal_driver_riscv_plic0_affinity_set_threshold(struct metal_interrupt controller,
                                                     metal_affinity bitmask,
                                                     unsigned int level);

unsigned int
__metal_driver_riscv_plic0_affinity_get_threshold(struct metal_interrupt controller,
                                                     int context_id);
