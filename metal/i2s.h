...
struct metal_i2s_vtable 
{
	...
	int (*intr_unmask)(struct metal_i2s *i2s,struct metal_i2s_config *cfg);
...
__inline__ int metal_i2s_intr_unmask(struct metal_i2s *i2s,struct metal_i2s_config *cfg)
{
	return i2s->vtable->intr_unmask(i2s,cfg);
}
